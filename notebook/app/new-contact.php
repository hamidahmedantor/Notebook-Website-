...
<?php
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $newContact->setUsername($user->getUsername());
        

        include_once('connection.php');
        $sql = "INSERT INTO contacts (name, email,phone,blood_group,picture,username) VALUES ('".$newContact->getName()."','".$newContact->getEmail()."','".$newContact->getPhone()."','".$newContact->getBloodGroup()."','".$newContact->getPicture()."','".$newContact->getUsername()."')";
