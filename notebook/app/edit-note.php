...
<div class="content_area">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control form-control-sm"  value="<?php echo $title; ?>" name="name"/>
      </div>
      
    </div>
    <div class="form-group row">
      <label class="col-sm-2 col-form-label col-form-label-sm">Body :</label>
      <div class="col-sm-10">
    ...
    <div class="form-group row">		
      <label class="col-sm-2 col-form-label col-form-label-sm">Picture :</label>
      <div class="col-sm-10">	
...
<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
      $target_dir = "uploads/";
        ...
        {
            $newNote->setPicture($picture);
        }
        else{
            $newNote->setPicture($target_file);
        }
        
        $sql = "UPDATE notes SET title='".$newNote->getTitle()."', body='".$newNote->getBody()."', picture='".$newNote->getPicture()."' WHERE id='".$_GET["id"]."'";
        //$sql = "INSERT INTO notes (title,body,color,username) VALUES ('".$newNote->getTitle()."','".$newNote->getBody()."','"."color"."','".$newNote->getUsername()."')";
